...
function setDefaultFontType() {
  const defaultFontType = "sans-serif";
...
"use strict";
module.exports = JSON.parse('{"themes":["dark","light","cupcake","bumblebee","emerald","corporate","synthwave","retro","cyberpunk","valentine","halloween","garden","forest","aqua","lofi","pastel","fantasy","wireframe","black","luxury","dracula","cmyk","autumn","business","acid","lemonade","night","coffee","winter","dim","nord","sunset"],"fontSize":["text-base","text-sm","text-lg","text-xl","text-2xl"],"fontType":["sans-serif","serif","monospace"],"contrast":["normal","high","low"]}');
