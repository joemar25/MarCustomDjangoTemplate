...
function updateLocalStorageTheme(darkModeEnabled) {
  ...
  document.body.classList.remove(darkModeEnabled ? "light-theme" : "dark-theme");
  document.body.classList.add(darkModeEnabled ? "dark-theme" : "light-theme");
}
...
export function updateThemeToggleIcons(darkModeEnabled) {
  ...
  darkIcon.addEventListener("click", () => {
    ...
    updateLocalStorageTheme(false); // Add this line
  });

  lightIcon.addEventListener("click", () => {
    darkIcon.classList.remove("hidden");
    lightIcon.classList.add("hidden");
    updateLocalStorageTheme(true); // Add this line
  });
}